  ...
  return (
    ...
    >
      ...
      <div className="relative mb-4">
        ...
        <div className="h-1 w-full bg-gradient-to-r from-primary-500 to-accent-500 rounded-full mb-4 opacity-0 group-hover:opacity-100 transition-opacity"></div>
      </div>
      ...
      <div className="flex flex-wrap gap-3 text-xs text-gray-500 mb-4">
        ...
        <span className="flex items-center gap-1 bg-pink-50 text-pink-700 px-2 py-1 rounded-lg">
      ...
      <div className="flex items-center justify-between pt-4 border-t border-gray-100">
        ...
        {onLike && (
          <button
            ...
            className="flex items-center gap-1 px-3 py-1.5 text-sm font-medium text-primary-600 hover:bg-primary-50 rounded-lg transition-all"
          >
            <span>❤️</span> Like
          </button>
        )}
